...
| `DSLV_DASHBOARD_COMPACT` | `1` forces the compact 10" Lenovo HDMI touchscreen layout (2×2 status grid, no mega-banner). Auto-detected when terminal is narrower than 140 cols; also toggled live with the `c` key. |
