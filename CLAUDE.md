# DSLV-ZPDI Agent Doctrine — Binding Rules for Claude Code

> **READ THIS FILE FIRST. It is automatically loaded by Claude Code and Grok Build.**
...
2. `/root/dslv-zpdi/AGENTS.md` — project conventions (this doctrine is appended there)
...
- **Claude Code (you)**: Lead architect / security reviewer. Owns multi-file design and threat modeling.
