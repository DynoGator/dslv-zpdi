...
**Document ID:** `SPEC-UPDATE-PHASE-2A-LBE-1421`
...
The previously specified Leo Bodnar Mini GPSDO has been officially superseded by the **Leo Bodnar LBE-1421**. The LBE-1421 provides critical advantages for day-to-day field operations:

| Feature | LBE-1421 (Current) | Mini GPSDO (Deprecated) |
|---------|---------------------|------------------------|
...
- **Note:** The LBE-1421 outputs 3.3V logic natively, so no level-shifter is required for the Pi 5 RP1 chip.

### 3.3 Power & Telemetry
Connect the LBE-1421 via USB-C to the Pi 5. This provides power and establishes the NMEA virtual serial connection for software observation.
