...
3. **SDR Hardware Selectability**: Implemented a selection dropdown allowing operators to actively toggle between PlutoSDR (IIO), LibreSDR, and HackRF (legacy/optional) One.
