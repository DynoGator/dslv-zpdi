"""
SPEC-004A.4-PPS — Kernel PPS edge listener via /dev/ppsX character device.
    ...
    def _run(self) -> None:
        ...
        try:
            while not self._stop.is_set():
                ...
                # This is as close to the physical edge as scheduling allows.
                mono_ns = time.monotonic_ns()

                # Retrieve the kernel-timestamped edge (CLOCK_REALTIME).
