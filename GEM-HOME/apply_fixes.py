...
replace_in_file('../PHASE_2A_HARDWARE_BUILD_LIST.md',
    '1. **RF Phase Lock (ADC Slave):** Connect SMA cable from LBE-1421 `Output` port directly to PlutoSDRplus `CLKIN` port. This phase-locks the SDR\'s ADC to the GPS constellation.',
    '1. **RF Phase Lock (ADC Slave):** Connect SMA cable from LBE-1421 `Out2` port (set to 10 MHz) directly to PlutoSDRplus `CLKIN` port (50 \u03a9). This phase-locks the SDR\'s ADC to the GPS constellation.'
)
replace_in_file('../PHASE_2A_HARDWARE_BUILD_LIST.md',
...
replace_in_file('../PHASE_2A_TIER_1_BUILD_SHEET.md',
    '**Step 4.** **RF Phase Lock (ADC Slave):** Connect SMA Male-to-Male cable (50 Ohm, \u2264 1FT) from the LBE-1421 `Output` port to the PlutoSDRplus `CLKIN` port.',
    '**Step 4.** **RF Phase Lock (ADC Slave):** Connect SMA Male-to-Male cable (50 Ohm, \u2264 1FT) from the LBE-1421 `Out2` port (set to 10 MHz) to the PlutoSDRplus `CLKIN` port (50 \u03a9).'
)
replace_in_file('../PHASE_2A_TIER_1_BUILD_SHEET.md',
