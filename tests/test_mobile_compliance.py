...
from dslv_zpdi.layer3_telemetry.mobile_router import route_packet
...
def test_global_r_weighting():
    ...
    assert abs(scorer.compute_global_r() - 0.8) < 0.001  # adapted to master CoherenceScorer API (lowercase r)
